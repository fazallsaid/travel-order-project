<dialog id="customerEditModal{{$cust->user_id}}" class="h-[50%] w-[65%] bg-white p-[5rem] rounded-xl" onkeydown="if (event.key === 'Escape') { unblurBackground(); this.close(); }">
    <div class="w-full p-[2rem] sm:p-[2rem] flex flex-col justify-center relative">
        <h2 class="text-2xl font-bold text-gray-800 mb-2">
            Edit pelanggan {{$cust->first_name . " " . $cust->last_name}}
        </h2>
        ...
        <form id="addcustomerForm" action="{{ url('admin/customer/edit/process') }}" method="POST">
            @csrf
            <div class="mb-4">

...
<div class="hero py-40 bg-slate-200 relative before:block before:absolute before:bg-black before:h-full before:w-full before:top-0 before:z-10 before:opacity-70">
  ...
  <div class="relative z-30 mx-auto max-w-screen-xl flex gap-20">
    <div class="w-2/3">
      <h1 class="text-7xl text-white font-extrabold">Travel murah dengan Andhika Travel!</h1>
      <div class="flex items-center gap-3 text-white my-6 text-4xl">

      </div>
      <p class="text-slate-200">
        Travel dari Jogja ke Pacitan, cuma 100 ribu saja!
      </p>
    </div>
    <div class="w-1/3">
      <form action="" class="bg-blue-500 p-10">
        <div class="flex flex-col mb-4">
          <label for="" class="text-white text-sm mb-2">Dari</label>
          <select class="h-12 bg-white px-4 placeholder:text-sm placeholder:text-slate-400">
        ...
        <div class="flex flex-col mb-4">
          <label for="" class="text-white text-sm mb-2">Tujuan</label>
          <select class="h-12 bg-white px-4 placeholder:text-sm placeholder:text-slate-400">
        ...
        <div class="flex flex-col mb-4">
          <label for="" class="text-white text-sm mb-2">Tanggal Penjemputan</label>
          <div class="h-full relative">
          </div>
          <input type="date" class="h-12 bg-white px-4 placeholder:text-sm placeholder:text-slate-800">
        </div>
        <div class="flex flex-col mb-4">
            <label for="" class="text-white text-sm mb-2">Jam Penjemputan</label>
            <div class="h-full relative">
            </div>
            <input type="time" class="h-12 bg-white px-4 placeholder:text-sm placeholder:text-slate-800">
          </div>
